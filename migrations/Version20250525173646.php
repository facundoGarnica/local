 ...
 */
final class Version20250525173646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE comision ADD ciclo_lectivo VARCHAR(4) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE comision DROP ciclo_lectivo
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE cursada_docente CHANGE cese cese DATE DEFAULT 'NULL'
        SQL);
